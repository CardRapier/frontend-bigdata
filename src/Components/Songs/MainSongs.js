...
function MainSongs() {
  ...
  const getFavoriteSongs = () => {
    axios
      .post(process.env.REACT_APP_API_URL + "/recommendation/songs/", {
  ...
  const searchSongs = (text) => {
    if (text.target.value !== "") {
      axios
        .post(process.env.REACT_APP_API_URL + "/search/song/", {
  ...
  const getPopularSongs = () => {
    axios
      .get(process.env.REACT_APP_API_URL + "/recommendation/songs/populars/")
      .then((res) => {
  ...
  const getLikedSongs = () => {
    axios
      .get(process.env.REACT_APP_API_URL + "/recommendation/songs/most-liked/")
      .then((res) => {
